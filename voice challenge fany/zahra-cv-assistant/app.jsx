...
Zahra's answer (in ${langName}):`;
  ...
  try{
    ...
    throw new Error("No connection to the AI service. If you opened this as a local file, it needs to run on Vercel where /api/ask exists.");
  }
  if(r.status === 404){
    throw new Error("The /api/ask function was not found (404). On Vercel, make sure the 'api' folder sits at the deployment root, then redeploy.");
  }
  if(!r.ok){
